    ...
    void Update()
    {
        if (!IsCentered)
        {
            ...
            if (transform.position.x < centerPosition.x && sideMovement == -1)
            {
                ...
                IsCentered = true;
                sideMovement = 0;
                redAnimator.SetBool("Moving", false);
                redAnimator.SetFloat("Horizontal", sideMovement);
            }
        ...
        if (inputEnabled)
        {
            ...
            if (sideMovement != 0)
            {
                ...
                redAnimator.SetBool("Moving", true);
            }
            ...
            if (confirmInput == 1 && !FinalConfirm)
            {
                ...
                redAnimator.SetTrigger("Confirm");
                FinalConfirm = true;
            }
        }
        ...
        {
            redrb.MovePosition(redrb.position + moveVelocity * Time.fixedDeltaTime);
        }
